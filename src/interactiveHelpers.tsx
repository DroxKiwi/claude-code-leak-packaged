...
import { type StatsStore, createStatsStore } from './context/stats.js'
...
export async function showSetupScreens(
	...
	// On homespace, DROX_API_KEY peut être présente pour les enfants ; le harness lit la clé via harnessApiKeyEnv.
	const droxKey = getProcessEnvInferenceApiKey()
	if (droxKey && !isRunningOnHomespace()) {
		const customApiKeyTruncated = normalizeApiKeyForConfig(droxKey)
