 ...
 * so DROX_API_BASE_URL/proxy/mTLS in settings would be invisible and preconnect
...
export function preconnectAnthropicApi(): void {
	...
	// Uniquement l’URL configurée par l’utilisateur — jamais d’URL OAuth / cloud implicite.
