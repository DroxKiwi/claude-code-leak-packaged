 ...
 * via shell expansion (e.g., ${DROX_API_KEY}) in Bash tool commands.
 *
...
export function subprocessEnv(): NodeJS.ProcessEnv {
	...
	for (const k of GHA_SUBPROCESS_SCRUB) {
		...
		// secrets like INPUT_DROX_API_KEY. No-op for vars that aren't action inputs.
		delete env[`INPUT_${k}`]
	}
	return env
}
