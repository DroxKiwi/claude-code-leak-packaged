...
import {
	...
	isEnvTruthy,
	isThirdPartyCliUpdateDisabledForFork,
} from './envUtils.js'
...
/** Same upstream check as `cli/update.ts` (DISABLE_AUTOUPDATER / config / fork without DROX_CLI_UPDATE_ENABLED). */
export function isUpstreamAutoUpdateCheckBlocked(): boolean {
	return getAutoUpdaterDisabledReason() !== null || isThirdPartyCliUpdateDisabledForFork()
}
