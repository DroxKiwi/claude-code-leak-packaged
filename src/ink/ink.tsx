...
import { type Frame, type FrameEvent, emptyFrame } from './frame.js'
...
import { type MatchPosition, applyPositionedHighlight, scanPositions } from './render-to-screen.js'
...
export default class Ink {
	...
	enterAlternateScreen(): void {
		...
		this.options.stdout.write(
			...
			}\x1b[?1004l\x1b[0m\x1b[?25h\x1b[2J\x1b[H`, // cursor home
		)
	}
	...
	exitAlternateScreen(): void {
		this.options.stdout.write(
			`${this.altScreenActive ? ENTER_ALT_SCREEN : ''}\x1b[2J\x1b[H${this.altScreenMouseTracking ? ENABLE_MOUSE_TRACKING : ''}${this.altScreenActive ? '' : '\x1b[?1049l'}\x1b[?25l`, // hide cursor (Ink manages)
		)
		this.resumeStdin()
		if (this.altScreenActive) {
			this.resetFramesForAltScreen()
