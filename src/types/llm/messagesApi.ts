/**
 * Types Messages API (beta) — shapes aligned with @anthropic-ai/sdk beta messages.
 */
...
export type BetaStopReason = BetaMessage['stop_reason']
...
export interface BetaMessageStreamParams extends MessageCreateParamsBase {
...
/** Outil web search bêta (corps requête Messages). */
