...
/** Where a message originated. Undefined means direct user input at keyboard. */
...
/** Alias partagé pour les helpers SDK ↔ interne (compact_metadata). */
export type CompactMetadata = NonNullable<SystemCompactBoundaryMessage['compactMetadata']>
