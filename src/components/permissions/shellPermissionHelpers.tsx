...
export function generateShellSuggestionsLabel(
	...
	if (hasDirectories && !hasReadPaths && !hasCommands) {
		...
		return (
			<Text>Yes, and always allow access to {formatPathList(directories)} from this project</Text>
		)
	}
	...
	if ((hasDirectories || hasReadPaths) && !hasCommands) {
		...
		if (hasDirectories && hasReadPaths) {
			...
			return (
				<Text>Yes, and always allow access to {formatPathList(allPaths)} from this project</Text>
			)
		}
	}
	if ((hasDirectories || hasReadPaths) && hasCommands) {
