...
export function ClaudeInChromeOnboarding(t0) {
	...
	if ($[6] !== t4) {
		t5 = (
			<Text>
				...
				from Claude Code. You can navigate websites, fill forms, capture screenshots, record GIFs,
				and debug with console logs and network requests.{t4}
			</Text>
		)
		$[6] = t4
		$[7] = t5
	...
	if ($[10] !== t6) {
		t7 = (
			<Text dimColor={true}>
				Site-level permissions are inherited from the Chrome extension. Manage permissions in the
				Chrome extension settings to control which sites Claude can browse, click, and type on{t6}.
			</Text>
		)
		$[10] = t6
		$[11] = t7
