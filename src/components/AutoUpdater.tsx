...
import { getGlobalConfig, isUpstreamAutoUpdateCheckBlocked } from '../utils/config.js'
...
export function AutoUpdater({
	...
	const checkForUpdates = React.useCallback(async () => {
		...
		if (isUpstreamAutoUpdateCheckBlocked()) {
			logForDebugging('AutoUpdater: Skipping update check (upstream blocked by policy)')
			return
		}
