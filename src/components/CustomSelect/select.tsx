	...
	if (
		...
		bb0: {
									...
									<SelectInputOption
										...
										onSubmit={(value_0) => {
											const hasImageAttachments =
												pastedContents && Object.values(pastedContents).some(_temp5)
											if (
												value_0.trim() ||
												hasImageAttachments ||
												option_1.allowEmptySubmitToCancel
											) {
									...
									<SelectInputOption
										...
										onSubmit={(value_2) => {
											const hasImageAttachments_0 =
												pastedContents && Object.values(pastedContents).some(_temp6)
											if (
												value_2.trim() ||
			...
			const hasDescriptions =
				!inlineDescriptions && !hasInputOptions && state.visibleOptions.some(_temp8)
						...
						<SelectInputOption
							...
							onSubmit={(value_4) => {
								const hasImageAttachments_1 =
									pastedContents && Object.values(pastedContents).some(_temp9)
