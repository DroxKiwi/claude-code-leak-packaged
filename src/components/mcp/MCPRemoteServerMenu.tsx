...
import { Box, Link, Text, color, useInput, useTheme } from '../../ink.js'
			...
			<Box flexDirection="column" gap={1} padding={1}>
				...
				{isAuthenticating && authorizationUrl && manualCallbackSubmit && (
					<Box flexDirection="column" marginTop={1}>
						<Text dimColor>
							If the redirect page shows a connection error, paste the URL from your browser&apos;s
							address bar:
						</Text>
						<Box>
		...
		return (
			<Box flexDirection="column" gap={1} padding={1}>
				...
				{claudeAIClearAuthBrowserOpened ? (
					...
					<>
						<Text>
							This will open claude.ai in the browser. Find the MCP server in the list and click
							&quot;Disconnect&quot;.
						</Text>
						<Box marginLeft={3} flexDirection="column">
							<Text color="permission">
