...
import { getCreditBalanceTooLowUserMessage } from '../../constants/product.js'
...
import { NO_RESPONSE_REQUESTED, isEmptyMessageText } from '../../utils/messages.js'
...
export function AssistantTextMessage(t0) {
	...
	switch (text) {
		...
		case CREDIT_BALANCE_TOO_LOW_ERROR_MESSAGE: {
			return (
				<MessageResponse height={1}>
					<Text color="error">{getCreditBalanceTooLowUserMessage()}</Text>
				</MessageResponse>
			)
		}
