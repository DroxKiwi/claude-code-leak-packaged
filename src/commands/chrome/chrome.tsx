	...
	if ($[20] === Symbol.for('react.memo_cache_sentinel')) {
		t6 = (
			<Text>
				...
				from Claude Code. Navigate websites, fill forms, capture screenshots, record GIFs, and debug
				with console logs and network requests.
			</Text>
		)
		$[20] = t6
	} else {
		...
		t9 = !isDisabled && (
			<>
				...
				<Text dimColor={true}>
					...
					Chrome extension settings to control which sites Claude can browse, click, and type on.
				</Text>
			</>
		)
		$[25] = handleAction
