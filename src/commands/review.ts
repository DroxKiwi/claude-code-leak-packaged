...
// user triggers, so the description carries "Claude Code in remote session" + URL.
...
const ultrareview: Command = {
	type: 'local-jsx',
	name: 'ultrareview',
	description: `~10–20 min · Finds and verifies bugs in your branch. Runs in Claude Code in remote session. See ${CCR_TERMS_URL}`,
