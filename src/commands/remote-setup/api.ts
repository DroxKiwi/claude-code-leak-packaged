...
/**
 * Best-effort default environment creation. Mirrors the remote-session onboarding's
 ...
 * so re-running /remote-setup doesn't pile up duplicates. Failures are
 * non-fatal — the token import already succeeded, and the remote state
