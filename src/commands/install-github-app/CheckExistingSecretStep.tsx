...
export function CheckExistingSecretStep(t0) {
	const $ = _c(42)
	const { useExistingSecret, secretName, onToggleUseExistingSecret, onSecretNameChange, onSubmit } =
		t0
	...
	if ($[16] === Symbol.for('react.memo_cache_sentinel')) {
		t9 = (
			<Box marginBottom={1}>
				<Text color="warning">DROX_API_KEY already exists in repository secrets!</Text>
			</Box>
		)
		$[16] = t9
	} else {
