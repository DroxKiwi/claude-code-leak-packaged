...
function getPrivacySettingsFallbackMessage(): string {
	return `Review and manage your privacy settings at ${getCloudDataPrivacySettingsUrl()}`
}
export async function call(onDone: LocalJSXCommandOnDone): Promise<React.ReactNode | null> {
	...
	if (!qualified) {
		onDone(getPrivacySettingsFallbackMessage())
		return null
	}
	...
	return (
		<GroveDialog showIfAlreadyViewed={true} onDone={onDoneWithDecision} location={'settings'} />
	)
}
